...
// SONIQ: Use our sipgo fork with OnResponse middleware for persistent TLS INVITE handling
replace github.com/livekit/sipgo => github.com/jonnyweareone/sipgo v0.0.0-20260510094143-ffedb9a837f9
